...
<template>
  <div class="component-container">
    ...
    <div v-if="!has_valid_expiry"
         style="font-weight: 600; font-size: 16px; text-align: left; margin-bottom: 10px; color: blue; margin-top: 8px">Freet has no expiration date</div>
    <div v-else
         style="font-weight: 600; font-size: 16px; text-align: left; margin-bottom: 10px; color: blue;  margin-top: 8px">Current Expiration: {{curr_expiration}}</div>
...
export default {
  ...
  methods: {
    ...
    setExpiry(){
      ...
      this.$emit("addExpiry", date_string);
